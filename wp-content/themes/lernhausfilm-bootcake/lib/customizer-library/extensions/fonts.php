...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'bootcake' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'bootcake' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'bootcake' ),
		'cyrillic'     => __( 'Cyrillic', 'bootcake' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'bootcake' ),
		'devanagari'   => __( 'Devanagari', 'bootcake' ),
		'greek'        => __( 'Greek', 'bootcake' ),
		'greek-ext'    => __( 'Greek Extended', 'bootcake' ),
		'khmer'        => __( 'Khmer', 'bootcake' ),
		'latin'        => __( 'Latin', 'bootcake' ),
		'latin-ext'    => __( 'Latin Extended', 'bootcake' ),
		'vietnamese'   => __( 'Vietnamese', 'bootcake' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'bootcake' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'bootcake' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'bootcake' ),
